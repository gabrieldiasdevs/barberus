    ...
    <div className="flex h-full flex-col gap-6 py-6">
      ...
      <div className="flex flex-col px-2">
        <SheetClose asChild>
          <Link href="/">
            <Button
              variant="ghost"
              className="h-auto w-full cursor-pointer justify-start gap-3 rounded-full px-5 py-3"
            >
      ...
      <div className="flex flex-col gap-1">
        <Link
          ...
          className="hover:text-primary h-10 w-full cursor-pointer justify-start rounded-full px-5 py-3 hover:bg-transparent"
        >
